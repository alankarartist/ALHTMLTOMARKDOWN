...
class AlHtmlToMarkdown():
    ...
    def __init__(self):
        ...
        icon = Image.open(os.path.join(cwd+'\\UI\\icons', 'alhtmltomarkdown.ico'))
        ...
        titleLabel = Label(titleBar, text='ALHTMLTOMARKDOWN', fg='#909090', bg='#141414', font=appHighlightFont)
